...
public class ValueFragment extends ListFragment implements LoaderCallbacks<Cursor> {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        adapter = new org.openhds.mobile.clip.adapter.CustomCursorAdapter(getActivity(), R.layout.list_item, null, HIERARCHY_COLUMNS,
                VIEW_BINDINGS, 0);
        ...
        switch (arg0) {
	        ...
	        case INDIVIDUAL_LOADER:
	            ...
	            return new CursorLoader(getActivity(), OpenHDS.Individuals.CONTENT_ID_URI_BASE, null,
	                    OpenHDS.Individuals.COLUMN_INDIVIDUAL_RESIDENCE + " = ? AND (" + OpenHDS.Individuals.COLUMN_RESIDENCE_END_TYPE +"='NA' OR " + OpenHDS.Individuals.COLUMN_RESIDENCE_END_TYPE +"='DTH')",
    ...
    private String buildFilter(Bundle arg1) {
        ...
        if (builder.length() > 0)
            ...
            builder.append(OpenHDS.Individuals.COLUMN_RESIDENCE_END_TYPE).append("!='OMG'"); //View only resisdent persons
